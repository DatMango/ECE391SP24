...
uint32_t cursor_location[3];

int32_t printf(int8_t *format, ...);
void putc(uint8_t c);
// modified putc funtion to modify active terminals (terminal not shown)
void putcvmem(uint8_t c, int active_terminal);
//modified putc function to support backspace function
void bputc(uint8_t c);

//scrolls screen up by copying video memory locations up
void scroll();
...
//updates cursor location in terminal based on x and y inputs
